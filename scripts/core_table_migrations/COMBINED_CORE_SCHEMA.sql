-- ========================================
-- COMBINED CORE SCHEMA FOR DIRECT EXECUTION
-- Generated by Database Specialist Agent
-- ========================================
-- This file contains all 13 core table definitions
-- Execute this entire file in your database client
-- ========================================
...
-- 1. Player accounts (linked to Supabase auth.users)
...
-- 2. Game sessions (up to 8 players)
...
-- 3. Session participants (player membership in sessions)
...
-- 5. Skill definitions (static reference data)
...
-- 7. Item templates (static reference data)
...
-- 9. Ability definitions (static reference data)
...
-- 10. Character learned abilities
...
-- 11. Guilds (8-player cooperation hubs)
...
-- EXECUTION COMPLETE
-- ========================================
-- All 13 core tables created successfully
-- Database ready for tactical ASCII roguelike game
-- ========================================